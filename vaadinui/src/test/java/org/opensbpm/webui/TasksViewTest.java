...
public class TasksViewTest {
    ...
    public void listTasks() throws Exception {
        ...
        //given
        TaskInfo taskInfo = new TaskInfo(Long.MIN_VALUE, Long.MIN_VALUE, "Test Process", "Test State", LocalDateTime.now());
        when(sbpmEngine.getTasks(anyString())).thenReturn(Stream.of(taskInfo));
