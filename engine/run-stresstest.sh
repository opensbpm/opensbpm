...
#docker run --rm --name stresstest-jdoe opensbpm/stresstest --opensbpm.username=jdoe --opensbpm.password=jdoe &
#docker run --rm --name stresstest-miriam opensbpm/stresstest --opensbpm.username=miriam --opensbpm.password=miriam &
