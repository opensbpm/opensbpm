...
@SpringBootTest
@DirtiesContext
public class WorkflowsViewTest {
    ...
    public void listModels() throws Exception {
        UI.getCurrent().navigate(WorkflowsView.class);
        ...
        when(sbpmEngine.findStartableProcessModels()).thenReturn(Arrays.asList(processModelInfo));
